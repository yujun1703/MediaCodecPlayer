...
public class AudioDecoderPlayer {
    ...
    AudioTrack player;
    public AudioDecoderPlayer(InputStream is)
    {
                ...
                try {
                    ...
                    while (isPlaying) {
                        try {
                            ...
                            //while(len<1000)
                            {
                                //len+=inputStream.read(data,0,data.length-len);
                                readlen=inputStream.read(data,0,data.length);
                                len+=readlen;
                                Log.d("AudioDecoder", "read len:"+len);
                            }
                            ...
                            if (inputBufferIndex >= 0) {
                                ...
                                inputBuffer.clear();
                                Log.d("AudioDecoder", "wait,len:"+readlen);
                                inputBuffer.put(data);
                                decoder.queueInputBuffer(inputBufferIndex, 0, readlen, 0, 0);
